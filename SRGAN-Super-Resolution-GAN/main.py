...
parser.add_argument("--LR_path", type = str, default = '/content/drive/MyDrive/Colab Notebooks/SRGAN-Super-Resolution-GAN/test_data/test/LR')
parser.add_argument("--GT_path", type = str, default = '/content/drive/MyDrive/Colab Notebooks/SRGAN-Super-Resolution-GAN/test_data/test/HR')
